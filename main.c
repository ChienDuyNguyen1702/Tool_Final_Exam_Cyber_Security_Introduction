...
#include <stdlib.h>
#include "./lib/OTP.h"
#include "./lib/LuyThuaSoDu.h"
#include "./lib/RSA_giai_ma.h"
#include "./lib/Euclid.h"
#include "./lib/Elliptic.h"
...
int main(){
    ...
    do
    {
        ...
        case 6:
            printf("====================================================\n");
            printf("Enter n: ");scanf("%d",&n6);
            printf("Enter e: ");scanf("%d",&e6);
            printf("----------------------------------------------------\n");
            do
            {
                printf("Enter Sigma: ");scanf("%d",&sigma6);
                printf("----------------------------------------------------\n");
